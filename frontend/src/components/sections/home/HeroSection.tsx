...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden min-h-screen flex flex-col justify-center pt-20 pb-16 bg-white">
      ...
      <div
        className="bg-blob bg-[#80c2cb]/20 w-[500px] h-[500px] -top-32 -left-32 pointer-events-none"
      />
      <div
              ...
              <div className="relative z-10 p-6 flex flex-col h-full gap-4 bg-white/10 backdrop-blur-[2px]">
                ...
                <div className="grid grid-cols-2 gap-3 mt-2">
                  {[
                    ...
                    <div
                      key={i}
                      className="rounded-xl bg-white/70 border border-[#e2ecec]/50 p-3 flex items-center gap-2 backdrop-blur-sm"
                    >
