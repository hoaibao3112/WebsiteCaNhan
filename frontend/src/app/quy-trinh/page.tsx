...
const plans = [
  {
    name: 'Landing Page',
    subtitle: 'Tối ưu chuyển đổi cho chiến dịch quảng cáo & bán hàng.',
    price: '2.990.000₫',
    period: 'trọn gói',
    featured: false,
    features: [
      { label: 'Giao diện 1 trang chuẩn UI/UX chuyển đổi cao', ok: true },
      { label: 'Thiết kế độc bản theo thương hiệu', ok: true },
      { label: 'Responsive Mobile, Tablet, Desktop', ok: true },
      { label: 'Form thu lead về Email / Google Sheets', ok: true },
      { label: 'Tặng Tên miền quốc tế & SSL 1 năm', ok: true },
      { label: 'Bảo hành kỹ thuật 12 tháng', ok: true },
      { label: 'Hệ thống CMS quản trị bài viết', ok: false },
    ],
    cta: 'Chọn gói Landing Page',
    href: 'https://zalo.me/0374170367?text=Tôi%20muốn%20tư%20vấn%20gói%20Landing%20Page%20(2.990.000đ)',
  },
  {
    name: 'Doanh Nghiệp Chuẩn SEO',
    subtitle: 'Khẳng định uy tín thương hiệu & tăng trưởng khách hàng.',
    price: '5.990.000₫',
    period: 'trọn gói',
    featured: true,
    badge: 'PHỔ BIẾN NHẤT',
    features: [
      { label: 'Website 5-10 trang cấu trúc chuyên nghiệp', ok: true },
      { label: 'Thiết kế giao diện nhận diện độc quyền', ok: true },
      { label: 'Tối ưu Google PageSpeed 95+ & SEO On-page', ok: true },
      { label: 'Trang quản trị CMS Tiếng Việt tự chủ', ok: true },
      { label: 'Tích hợp Form liên hệ, Maps, Chat Zalo', ok: true },
      { label: 'Tặng Tên miền quốc tế & SSL 1 năm', ok: true },
  ...
  },
  {
    ...
    subtitle: 'Cửa hàng trực tuyến chuyên nghiệp & thanh toán tự động.',
    price: '9.990.000₫',
    period: 'trọn gói',
    featured: false,
    features: [
      { label: 'Catalogue sản phẩm & giỏ hàng', ok: true },
      { label: 'Tích hợp thanh toán VietQR, MoMo, VNPAY', ok: true },
      { label: 'Quản lý kho hàng & đơn hàng realtime', ok: true },
      { label: 'Thiết kế Figma độc quyền theo yêu cầu', ok: true },
      { label: 'Tích hợp đồng bộ CRM / Google Sheets', ok: true },
      { label: 'Bảo mật nâng cao & sao lưu tự động', ok: true },
      { label: 'Hỗ trợ ưu tiên 24/7 & bảo hành 12 tháng', ok: true },
    ],
    cta: 'Chọn gói E-Commerce',
